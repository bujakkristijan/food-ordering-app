          ...
          return(
            <div className='cart-item-container'>
              ...
              <div className='item-action-container'>
                <div className='button-icon-container update'>
                  <button className='btn-action update' onClick={() =>handleShowEdit(itemFromCart)}>Update</button>
                ...
                <div className='button-icon-container delete'>
                  <button className='btn-action delete' onClick={() => alertAreYouSureDelete(itemFromCart.mealId)}>Delete</button> 
